// Based on https://gist.github.com/scokmen/f813c904ef79022e84ab2409574d1b45 (no license)
...
export const enum Status {
   ...
   * status code in response before sending the body. The response 417
   ...
   * presume that the server has received the data and should issue a redirect
   ...
   * used as part of some form of digital cash or micro payment scheme, but that
   ...
   * for example, a GET request on a form that requires data to be presented via
  ...
  // ////////////////////////////////////////
  //   Below are unofficial error codes.   //
  // They may be specific to this project! //
  // ////////////////////////////////////////

  // 600-699: Unofficial error codes

  /**
   * An unknown error occurred.
   * This is a generic error code that can be used when an unexpected error
   * occurs, where it was not possible to determine the cause of the error.
   */
  UNKNOWN_ERROR = 600,
}
